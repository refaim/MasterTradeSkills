...
module:NewCraft(29732, "Copper Bangle", 15, {SpellSource.Trainer})  --TODO:CHECK
      :SetResult(55157)
...
--   module:NewCraft(41003, "Malachite Ring", 20, {})
--      :SetResult(81030)
--      :AddRecipe(70150, Quality.Uncommon, {})  --TODO: RecipeSource
--     :AddReagent(55156, 1) -- Rough Copper Ring
--     :AddReagent(774, 1) -- Malachite
--      :AddReagent(55150, 1) -- Rough Gritted Paper
--      :Save()
...
module:NewCraft(41334, "Shining Copper Cuffs", 80, {})
      :SetResult(56044)
...
module:NewCraft(41742, "Venomspire Diadem", 145, {})
      :SetResult(55338)
      :AddRecipe(70193, Quality.Rare, {})  --TODO: RecipeSource
      :AddReagent(3575, 10) -- Iron Bar
...
module:NewCraft(41283, "Astral Amulet", 175, {})  --TODO:CHECK
      :SetResult(55195)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(3575, 6) -- Iron Bar
      :AddReagent(3864, 2) -- Citrine
      :AddReagent(55249, 2) -- Crystal Quartz
      :AddReagent(55152, 3) -- Heavy Gritted Paper
...
module:NewCraft(41213, "Goldenshade Quartz Crown", 175, {SpellSource.Trainer})  --TODO: check
      :SetResult(55145)
...
module:NewCraft(41215, "The Golden Goblet", 175, {SpellSource.Trainer})  --TODO: check
      :SetResult(55146)
...
module:NewCraft(41217, "Powerful Citrine Pendant", 175, {SpellSource.Trainer})  --TODO: check
      :SetResult(55147)
      :AddReagent(3575, 12) -- Iron Bar
...
module:NewCraft(41221, "Ironsun Citrine Ring", 185, {SpellSource.Trainer})  --TODO: Check
      :SetResult(55141)
      :AddReagent(41332, 1) -- Rough Iron Ring
      :AddReagent(3577, 2) -- Gold Bar
      :AddReagent(3864, 4) -- Citrine
...
module:NewCraft(41223, "Shimmering Gold Necklace", 190, {SpellSource.Trainer})  --TODO: Check
      :SetResult(41340)
      :AddReagent(3577, 8) -- Gold Bar
...
module:NewCraft(41225, "Ironbloom Ring", 190, {SpellSource.Trainer})  --TODO: Check
      :SetResult(41342)
      :AddReagent(41332, 1) -- Rough Iron Ring
      :AddReagent(3575, 2) -- Iron Bar
...
module:NewCraft(41285, "Shimmering Moonstone Tablet", 200, {})
      :SetResult(56034)
...
module:NewCraft(41631, "Illuminated Gemstone", 200, {SpellSource.Trainer})  --TODO: Check
      :SetResult(56005)
      :AddReagent(55251, 1) -- Pure Moonstone
...
module:NewCraft(41744, "Bloodfire Circlet", 200, {})
      :SetResult(55339)
      :AddRecipe(70203, Quality.Uncommon, {})  --TODO: RecipeSource
...
module:NewCraft(41239, "Greater Binding Signet", 210, {SpellSource.Trainer})  --TODO: Check
      :SetResult(41346)
      :AddReagent(41322, 1) -- Rough Mithril Ring
      :AddReagent(55251, 1) -- Pure Moonstone
      :AddReagent(7909, 1) -- Aquamarine
...
module:NewCraft(41235, "Aquamarine Pendant", 215, {SpellSource.Trainer})  --TODO: Check
      :SetResult(55196)
      :AddReagent(3860, 8) -- Mithril Bar
      :AddReagent(7909, 2) -- Aquamarine
      :AddReagent(55152, 2) -- Heavy Gritted Paper
...
module:NewCraft(41241, "Royal Gemstone Staff", 215, {SpellSource.Trainer})  --TODO: Check
      :SetResult(41344)
...
module:NewCraft(41243, "Emberstone Idol", 220, {SpellSource.Trainer})  --TODO: Check
      :SetResult(41349)
...
module:NewCraft(41245, "Runed Truesilver Ring", 220, {SpellSource.Trainer})  --TODO: Check
      :SetResult(41347)
...
module:NewCraft(41085, "Emberstone Studded Ring", 225, {SpellSource.Trainer})  --TODO: Check
      :SetResult(41323)
      :AddReagent(41322, 1) -- Rough Mithril Ring
      :AddReagent(7077, 1) -- Heart of Fire
...
module:NewCraft(41307, "Gemkeeper's Folio", 235, {})  --TODO:CHECK
      :SetResult(55243)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(3860, 18) -- Mithril Bar
      :AddReagent(55249, 3) -- Crystal Quartz
...
module:NewCraft(41089, "Mithril Blackstone Necklace", 245, {})
      :SetResult(41324)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
      :AddReagent(3860, 10) -- Mithril Bar
...
module:NewCraft(41637, "Elegant Emerald Gemstone", 250, {})  --TODO:CHECK
      :SetResult(56009)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
...
module:NewCraft(41639, "Shining Sapphire Gemstone", 250, {})  --TODO:CHECK
      :SetResult(56007)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
...
module:NewCraft(41093, "Radiant Thorium Twilight", 255, {})
      :SetResult(55256)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
...
module:NewCraft(41095, "Glyph Codex", 260, {})
      :SetResult(55269)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
      :AddReagent(12359, 8) -- Thorium Bar
...
module:NewCraft(41265, "Starry Thorium Band", 260, {})
      :SetResult(55260)
      :AddRecipe(56030, Quality.Uncommon, {}) --TODO: Add recipe_sources
      :AddReagent(41321, 1) -- Rough Thorium Ring
      :AddReagent(7910, 2) -- Star Ruby
      :AddReagent(55246, 4) -- Shimmering Oil
      :AddReagent(55247, 1) -- Gemstone Oil
...
module:NewCraft(41305, "Golden Scepter of Authority", 260, {})  --TODO:CHECK
      :SetResult(56036)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(3577, 8) -- Gold Bar
      :AddReagent(3860, 2) -- Mithril Bar
...
module:NewCraft(41097, "Spellweaver Rod", 265, {})
      :SetResult(55271)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
...
module:NewCraft(41099, "Quicksilver Whirl", 265, {})
      :SetResult(55268)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
...
module:NewCraft(41311, "Stellar Gemguards", 270, {})  --TODO:CHECK
      :SetResult(55178)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(3860, 8) -- Mithril Bar
      :AddReagent(55249, 1) -- Crystal Quartz
...
module:NewCraft(41641, "Unstable Arcane Gemstone", 275, {})  --TODO:CHECK
      :SetResult(56011)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
...
module:NewCraft(41315, "Moonlit Charm", 275, {})  --TODO:CHECK
      :SetResult(55198)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(3860, 12) -- Mithril Bar
      :AddReagent(55251, 4) -- Pure Moonstone
...
module:NewCraft(41609, "Azerothian Ruby Gemstone", 275, {})
      :SetResult(56015)
      :AddRecipe(70160, Quality.Rare, {RecipeSource.Quest})
...
module:NewCraft(41101, "Crystalweft Bracers", 280, {})
      :SetResult(55273)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
...
module:NewCraft(41103, "Ethereal Frostspark Crown", 280, {})
      :SetResult(55267)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
      :AddReagent(12359, 12) -- Thorium Bar
...
module:NewCraft(41105, "Pendant of Arcane Radiance", 280, {})
      :SetResult(41330)
-- :AddRecipe(70106, Quality.Uncommon, {RecipeSource.Drop}) TODO: Add recipe_ID_sources
      :AddReagent(12359, 6) -- Thorium Bar
...
module:NewCraft(41782, "Golden Runed Ring", 285, {})
      :SetResult(56094)
      :AddRecipe(70211, Quality.Epic, {RecipeSource.Quest})
...
module:NewCraft(41313, "Garnet Guardian Staff", 290, {})  --TODO:CHECK
      :SetResult(55241)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
...
module:NewCraft(41643, "Glittering Sapphire Gemstone", 290, {})
      :SetResult(56057)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID & RecipeSource
      :AddReagent(12361, 1) -- Blue Sapphire
...
module:NewCraft(41708, "Opalstone Circle", 290, {})
      :SetResult(56065)
      :AddRecipe(70176, Quality.Rare, {}) --TODO: Add recipe_sources
      :AddReagent(41321, 1) -- Rough Thorium Ring
...
module:NewCraft(41710, "Deep Sapphire Circlet", 290, {})
      :SetResult(56066)
      :AddRecipe(70177, Quality.Rare, {RecipeSource.Quest})
      :AddReagent(56033, 1) -- Pure Gold Ring
...
module:NewCraft(41780, "Stormcloud Signet", 290, {})
      :SetResult(56093)
      :AddRecipe(70210, Quality.Epic, {}) --TODO: Add recipe_sources
      :AddReagent(41321, 1) -- Rough Thorium Ring
      :AddReagent(12655, 6) -- Enchanted Thorium Bar
      :AddReagent(7082, 3) -- Essence of Air
      :AddReagent(7081, 6) -- Breath of Wind
...
module:NewCraft(41271, "Pure Gold Ring", 295, {})  --TODO:CHECK
      :SetResult(56033)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(3577, 8) -- Gold Bar
      :AddReagent(12360, 2) -- Arcanite Bar
...
module:NewCraft(41317, "Twilight Opal Cascade", 300, {})  --TODO:CHECK
      :SetResult(55263)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(56033, 1) -- Pure Gold Ring
...
module:NewCraft(41309, "Stellar Ruby Ring", 300, {})  --TODO:CHECK
      :SetResult(55261)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(41321, 1) -- Rough Thorium Ring
...
module:NewCraft(41303, "Massive Jewel Circlet", 300, {})  --TODO:CHECK
      :SetResult(55264)
--:AddRecipe(, Quality.Uncommon, {})  --TODO: ID AND RecipeSource
      :AddReagent(41321, 1) -- Rough Thorium Ring
      :AddReagent(12364, 1) -- Huge Emerald
...
module:NewCraft(41778, "Stormcloud Shackles", 300, {SpellSource.Trainer})  --TODO: Check
      :SetResult(56092)
      :AddReagent(12655, 2) -- Enchanted Thorium Bar
...
--    module:NewCraft(41257, "Arcanum Baton", 300, {})
--       :SetResult(55259)
-- :AddRecipe(56027, Quality.Rare, {RecipeSource.Drop}) -- TODO: Add recipe_id
--        :AddReagent(41341, 1) -- Rough Truesilver Ring
--       :AddReagent(12655, 5) -- Enchanted Thorium Bar
--       :AddReagent(12361, 5) -- Blue Sapphire
--      :AddReagent(7076, 1) -- Essence of Earth
--      :AddReagent(55150, 8) -- Rough Gritted Paper
--     :AddReagent(55247, 3) -- Gemstone Oil
--     :Save()
...
module:NewCraft(41619, "Stunning Imperial Gemstone", 300, {})
      :SetResult(56014)
      :AddRecipe(70166, Quality.Rare, {RecipeSource.Quest})
      :AddReagent(55252, 1) -- Imperial Topaz
      :AddReagent(14344, 1) -- Large Brilliant Shard
...
module:NewCraft(41794, "Orb of Clairvoyance", 285, {})
      :SetResult(55362)
      :AddRecipe(70215, Quality.Rare, {RecipeSource.Vendor})
      :AddReagent(12359, 16) -- Thorium Bar
      :AddReagent(5116, 12) -- Long Tail Father
      :AddReagent(12361, 6) -- Blue Sapphire
      :AddReagent(12799, 6) -- Large Opal
      :AddReagent(55247, 2) -- Gemstone Oil
      :Save()

module:NewCraft(41796, "Grail of Forgotten Memories", 300, {})
      :SetResult(55363)
...
module:NewCraft(41821, "Gorgeous Mountain Gemstone", 300, {})
      :SetResult(61818)
      :AddRecipe(70209, Quality.Rare, {RecipeSource.Quest})
